...
<template>
  ...
  >
    <!-- Icon sidebar -->
    <div
      class="border-muted-200 hidden dark:border-muted-700 dark:bg-muted-800 pointer-events-auto relative z-20 flex h-full w-[80px] flex-col border-r bg-white transition-all duration-300"
      :class="isOpen ? '' : (locale === 'fa' ? 'translate-x-full xl:translate-x-0' : '-translate-x-full xl:translate-x-0')"
